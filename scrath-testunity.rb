...
pluginextrahoverzoom = 'sass scss/plugins/extra/hover-zoom.scss css/plugins/extra/hover-zoom-testunit.css'
raise pluginextrahoverzoom unless $?.to_i == 0
raise "Failed to Compile" unless File.exists?('css/plugins/extra/hover-zoom-testunit.css')
